package com.example.mytest.view.banner.indicator;
...
public class CircleIndicator2 extends LinearLayout{
    ...
    private int mIndicatorBackgroundResId = R.drawable.shape_dots_select;
    private int mIndicatorUnselectedBackgroundResId = R.drawable.shape_dots_unselect;
    ...
    public void configureIndicator(int indicatorWidth, int indicatorHeight, int indicatorMargin) {
        configureIndicator(indicatorWidth, indicatorHeight, indicatorMargin,
                R.animator.scale_with_alpha, 0, R.drawable.shape_dots_select, R.drawable.shape_dots_unselect);
    }
    ...
    private void checkIndicatorConfig(Context context) {
        ...
        mIndicatorBackgroundResId = (mIndicatorBackgroundResId == 0) ? R.drawable.shape_dots_unselect
                : mIndicatorBackgroundResId;
        mIndicatorUnselectedBackgroundResId =
