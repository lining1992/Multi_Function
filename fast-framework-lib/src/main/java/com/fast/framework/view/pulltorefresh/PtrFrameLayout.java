...
import com.fast.framework.view.pulltorefresh.util.PtrCLog;
 ...
 * support: pull to refresh / release to refresh / auto refresh / keep header view while refreshing / hide header
...
public class PtrFrameLayout extends ViewGroup {
    ...
    public boolean dispatchTouchEvent(MotionEvent e) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (DEBUG) {
                    boolean canMoveDown = mPtrHandler != null && mPtrHandler.checkCanDoRefresh(this, mContent,
                                                                                               mHeaderView);
                    PtrCLog.v(LOG_TAG,
                              "ACTION_MOVE: offsetY:%s, currentPos: %s, moveUp: %s, canMoveUp: %s, moveDown: %s: "
                                      + "canMoveDown: %s", offsetY, mPtrIndicator.getCurrentPosY(), moveUp, canMoveUp,
    ...
    private boolean tryToPerformRefresh() {
        ...
        //
        if ((mPtrIndicator.isOverOffsetToKeepHeaderWhileLoading() && isAutoRefresh()) || mPtrIndicator
